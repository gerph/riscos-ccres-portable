...
static const OBJECTLIST SaveAsObjectList[] = {
	...
	{iol_STRING, "alternative_window_name:", offsetof(saveas_object, alternative_window_name), NULL,           0                                  }
        ...
        int saveas_t2g(DATA *data, char *pszIn, toolbox_relocatable_object_base * object)
//      ================================================================================
{
...
return sizeof(saveas_object);
        ...
        void saveas_g2t(DATA *data, FILE * hf, toolbox_resource_file_object_base * object, char *pszStringTable, char *pszMessageTable, int cbObject)
//      ============================================================================================================================================
{
get_objects(data, hf, pszStringTable, pszMessageTable, (const char *)(object + 1), SaveAsObjectList, ELEMENTS(SaveAsObjectList), 1, cbObject);
}
