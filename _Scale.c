...
return sizeof(scale_object);
        ...
        void scale_g2t(DATA *data, FILE * hf, toolbox_resource_file_object_base * object, char *pszStringTable, char *pszMessageTable, int cbObject)
//      ===========================================================================================================================================
{
get_objects(data, hf, pszStringTable, pszMessageTable, (const char *)(object + 1), ScaleObjectList, ELEMENTS(ScaleObjectList), 1, cbObject);
}
